import { FirstNameModel } from "../classes/FirstNameModel.mjs";
import { Gender } from "../classes/index.mjs";
import { RandomProfileSingleRepository } from "../repositories/RandomProfileSingleRepository.mjs";

export class DbFirstNameSeed {
    ...
    public async Seed(): Promise<void> {
        ...
        try {
            for (let i = 0; i < names.length; i++) {
                const data = new FirstNameModel(names[i]?.name!);
